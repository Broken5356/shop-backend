...
public class HttpMsg {
    ...
    public static String NO_TYPE_NOW = "当前没有商品种类，请先创建！";
    ...
    public static String CREATE_ORDER_OK = "创建订单成功";
    public static String CREATE_ORDER_FAILED  = "创建订单失败";
    public static String SUCCESSFULLY_ORDER  = "获取订单成功";
    public static String GET_ORDER_FAILED  = "获取订单失败";
}
