	...
	<view class="cart-container" v-if="cart.length!==0">
		...
		<uni-swipe-action>
			...
			<block v-for="(goods ,i) in cart" :key="i">
				<uni-swipe-action-item :right-options="options" @click="swipeItemHander(goods)">
...
<script>
	...
	export default {
		...
		methods: {
			...mapMutations('m_cart', ['updateGoodsState', 'updateGoodsCount', 'removeGoodById']),
